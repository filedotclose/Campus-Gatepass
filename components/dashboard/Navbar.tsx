      ...
      <nav className="floating-nav shadow-2xl shadow-indigo-200/40">
        <div className="flex items-center gap-16">
          <div className="flex items-center gap-3 sm:gap-5 cursor-pointer group" onClick={() => router.push("/dashboard")}>
            <div className="w-10 h-10 sm:w-14 sm:h-14 bg-linear-to-br from-slate-900 to-indigo-900 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-xl transform group-hover:rotate-12 transition-all duration-500">
            ...
            <div className="flex flex-col">
              <span className="text-xl sm:text-2xl font-black text-slate-800 leading-none tracking-tighter">GATE<span className="text-indigo-600">PASS</span></span>
            </div>
          </div>
        ...
        <button
          ...
          className="group flex items-center justify-center sm:gap-5 px-4 sm:px-10 py-3 sm:py-4 bg-slate-900 text-white rounded-2xl sm:rounded-[2rem] hover:bg-indigo-600 transition-all duration-500 active:scale-95 shadow-2xl shadow-slate-900/10"
        >
