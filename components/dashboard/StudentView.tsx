      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="hidden lg:flex items-center gap-5 bg-white/50 backdrop-blur-sm px-6 py-3 rounded-2xl border border-slate-200/50 shadow-sm">
          ...
          <button
            onClick={fetchPasses}
            disabled={loading}
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg font-black text-[10px] uppercase tracking-widest transition-all hover:bg-blue-700 active:bg-white active:text-blue-600 disabled:opacity-50"
          >
