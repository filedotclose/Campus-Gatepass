      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="hidden lg:flex items-center gap-5 bg-white/50 backdrop-blur-sm px-6 py-3 rounded-2xl border border-slate-200/50 shadow-sm">
          ...
          <button
            onClick={fetchPasses}
            disabled={loading}
            className="flex active:bg-blue-900 active:text-white items-center gap-2 text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:text-indigo-700 transition-colors disabled:opacity-50"
          >
